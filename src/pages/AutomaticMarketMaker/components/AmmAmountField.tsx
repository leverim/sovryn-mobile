...
export const AmmAmountField: React.FC<LendingAmountFieldProps> = React.memo(
  ({ amount, onAmountChanged, price, balance, token, ...props }) => {
    ...
    return (
      <>
        <AmountFieldBase
          ...
          rightElement={<TokenPickerButton token={token} hideCaret />}
          bottomElement={
